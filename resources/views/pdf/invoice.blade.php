...
<body>
    <div class="cs-container">
        <div class="cs-invoice cs-style1">
                        ...
                        <tr>
                            <td style="border:none;">
                                <div class="cs-invoice_left" style="max-width: 100% !important;">
                                    <div class="cs-logo cs-mb5">
                                        <img style="width: 200px; height: 200px;"  src="Images/favicon/170713091865c0c02608722imgpsh_fullsize_anim.jpg" alt="Logo">
                            ...
                            <td style="border:none;">
                                <div class="cs-invoice_right cs-text_right" style="float: right;">
                                    <p class="cs-invoice_number cs-primary_color cs-mb5 cs-f16"><b class="cs-primary_color">Invoice No:</b> #{{ $appointment['test_id'] }}325</p>
                                    <p class="cs-invoice_date cs-primary_color cs-m0"><b class="cs-primary_color">Date:</b> {{ $appointment['date'] }} {{ $appointment['time'] }}</p>
                                </div>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table>
                        <tr>
                            <td>
                                <div class="cs-invoice_left" style="max-width: 100% !important;">
                                    <p>
                                        <b class="cs-primary_color">Patient Name:</b> {{ $patient->name }}<br>
                                        <b class="cs-primary_color">Age & Sex:</b> {{ $patient->age }} / {{ ($patient->sex) }}<br>
                                        <b class="cs-primary_color">Contact No:</b> {{ $patient->phone }}<br>
                                        <b class="cs-primary_color">Date & Time:</b> {{ $appointment['date'] }} {{ $appointment['time'] }}<br>
                                    </p>
                                </div>
                            </td>
                        </tr>
                    ...
                    <div class="cs-round_border">
                        <div class="cs-table_responsive">
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="cs-width_3">Test</td>
                                        <td class="cs-width_2">{{ ucfirst($appointment['test_type'] ?? '') }}</td>
                                        <td class="cs-width_4">{{ $appointment['test_description'] ?? '-' }}</td>
                                        <td class="cs-width_2">{{ number_format($appointment['booking_amount'], 2) }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <table>
                            <tbody>
                                <tr class="cs-border_left">
                                    ...
                                    <td class="cs-width_3 cs-semi_bold cs-focus_bg cs-primary_color cs-text_right">Rs.{{ number_format($appointment['booking_amount'], 2) }}</td>
                                </tr>
                                <tr class="cs-border_left">
                        ...
                        <table>
                            <tbody>
                                <tr class="cs-border_none">
                                    ...
                                    <td class="cs-width_3 cs-border_top_0 cs-bold cs-f16 cs-primary_color cs-text_right">Rs.{{ number_format($appointment['booking_amount'], 2) }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div class="cs-note">
            <p class="cs-m0">1. These tests would be performed by Diagnomitra.</p>
                ...
                5. By accepting this invoice / transacting with the Company, I agree/confirm having understood the Terms and Conditions mentioned in Diagnomitra Privacy
