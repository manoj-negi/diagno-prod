    ...
    public function index(Request $request)
{
    ...
    public function indexDiagno(Request $request)
    {
        $data['title'] = 'Lab Profile';
        $data['page_name'] = "List";
        $dataArray = LabProfile::where('lab_id', 761);
    ...
    public function create(Request $request)
    {
        ...
        $data['diagnomitraProfiles'] = LabProfile::where('lab_id', 761)->get();
...
// }
    ...
    public function edit($id)
    {
        ...
        if (Auth::user()->roles->contains(4)) {
            ...
            $categories['diagnomitraProfiles'] = LabProfile::where('lab_id', 761)->get(); // Assuming lab_id 585 is Diagnomitra lab
        }
